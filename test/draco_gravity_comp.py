...
if __name__ == "__main__":
    ...
    p.resetJointState(robot, joint_id["r_hip_aa"], np.radians(-hip_yaw_angle),
                      0.)
    p.resetJointState(robot, joint_id["r_hip_fe"], -np.pi / 6, 0.)
    p.resetJointState(robot, joint_id["r_knee_fe_jp"], np.pi / 6, 0.)
    p.resetJointState(robot, joint_id["r_knee_fe_jd"], np.pi / 6, 0.)
    p.resetJointState(robot, joint_id["r_ankle_fe"], -np.pi / 6, 0.)
