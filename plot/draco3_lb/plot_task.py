...
tasks = [
    ...
    'l_foot_contact_pos', 'l_foot_contact_vel', 'l_foot_contact_quat',
    'l_foot_contact_ang_vel', 'r_foot_contact_pos', 'r_foot_contact_vel',
    'r_foot_contact_quat', 'r_foot_contact_ang_vel'
]

weights = [
    'w_com', 'w_torso_com_link_ori', 'w_l_foot_contact',
