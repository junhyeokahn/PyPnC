...
AtlasCompositeRigidBodyInertia::AtlasCompositeRigidBodyInertia()
  ...
  jac_f_y_ = new double *[jac_atlas_crbi_helper_n_out()];
...
Eigen::MatrixXd
AtlasCompositeRigidBodyInertia::ComputeInertia(const Eigen::Vector3d &base_pos,
...
Eigen::MatrixXd AtlasCompositeRigidBodyInertia::ComputeDerivativeWrtInput(
  ...
  jac_atlas_crbi_helper(const_cast<const double **>(jac_f_x_), jac_f_y_,
                        jac_f_iw, jac_f_w, jac_atlas_crbi_helper_checkout());
