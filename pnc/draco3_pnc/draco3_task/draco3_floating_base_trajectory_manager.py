...
class Draco3FloatingBaseTrajectoryManager(object):
    def __init__(self, base_pos_task, base_ori_task, robot):
        self._base_pos_task = base_pos_task
    ...
    def initialize_floating_base_interpolation_trajectory(
        ...
        self._ini_base_pos = self._robot.get_link_iso(
            self._base_pos_task.target_id)[0:3, 3]
        self._target_base_pos = target_com_pos
        ...
        # print("ini com: ", self._ini_base_pos)
        # print("end com: ", self._target_base_pos)
    ...
    def update_floating_base_desired(self, current_time):
        ...
        for i in range(3):
            com_pos_des[i] = interpolation.smooth_changing(
                self._ini_base_pos[i], self._target_base_pos[i],
        ...
        self._base_pos_task.update_desired(com_pos_des, com_vel_des,
                                           com_acc_des)
